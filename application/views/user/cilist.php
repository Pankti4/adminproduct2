  ...
  <div class="row">
    <div class="col-md-8">
      <table class="table table-striped">
        ...
        <?php if(!empty($cities)) { foreach($cities as $cities) { ?>
        <tr>
          <td><?php echo $cities['country_id']?></td>
          ...
          <td>
            <a href="<?php echo base_url().'user/City/edit/'.$cities['id']?>" class="btn btn-primary">Edit</a>
          </td>

          <td>
            <a href="<?php echo base_url().'user/City/delete/'.$cities['id']?>" class="btn btn-danger remove">Delete</a>
          </td>
