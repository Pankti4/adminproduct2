...
<div class="container" style="padding-top: 10px;">
  ...
  <hr>
  <form method="post" name="editProducts" action="<?php echo base_url().'user/Product/edit/'.$products['id'];?>">

     <div class="row">   
    <div class="col-md-6">
      <div class="form-group">
        <strong>Name:</strong>
        <input type="text" name="name" value="<?php echo set_value('name',$products['name']);?>" class="form-control">
